...
permalink: /docs/examples/example_1.html
---
...
The default application of CREST is the [iMTD-GC workflow](/docs/overview/workflows.html#imtd-gc-algorithm). 
...
With these settings, the workflow as presented [here](/docs/overview/workflows.html#imtd-gc-algorithm) is conducted.
